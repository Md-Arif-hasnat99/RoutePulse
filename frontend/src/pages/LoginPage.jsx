    ...
    <div className="auth-page">
      <div className="auth-panel">
        ...
        <p className="muted" style={{ fontSize: "17px", maxWidth: "400px", marginBottom: "40px" }}>
          Sign in to your dashboard to monitor shipments and manage logistics intelligence.
        </p>

        <div className="auth-highlight">
          <p className="label">System Status</p>
          <p className="value" style={{ color: "var(--accent)" }}>● All logistics nodes operational</p>
        </div>
      </div>
